...
const compRows = [
  ['Property', '2V', '3V', '4V'],
  ['Struts', '65', '120', '250'],
  ['Strut Types', '2 (A, B)', '3 (A, B, C)', '6 (A–F)'],
  ['Vertices / Hubs', '26', '46', '91'],
  ['Chord (A, shortest)', '0.5465', '0.3486', '0.2532'],
  ['Assembly Time', '40–60 hrs', '60–80 hrs', '80–120 hrs'],
  ['Wind Rating', '20–40 mph', '40–60 mph', '60–100 mph'],
  ['Build Cost (2026)', '$6.3k–8.6k', '$8.2k–10.7k', '$9.9k–13.4k'],
  ['Complexity', 'Low', 'Medium', 'High'],
  ['Lifespan', '2–3 years', '3–5 years', '5+ years'],
  ['Best For', 'Budget camping', 'Moderate use', 'Year-round'],
];
</script>

<svelte:head><title>Geodesic Dome Wiki</title></svelte:head>

<h1>Geodesic Dome Construction Wiki</h1>
<p class="tag">
  30-foot diameter geodesic domes built from PVC pipe or EMT conduit.
  Math from <em>"Geodesic Domes"</em> by Tom Davis, Berkeley Math Circle (2004).
  All models generated from first-principles icosahedron subdivision.
</p>
...
<div class="hero-grid">
  ...
  <a href="/dome/4v" class="hero-card">
    ...
    <span class="cta">View 4V →</span>
  </a>
</div>

<h2>Quick Comparison</h2>
<SpecTable rows={compRows} />
...
<div class="card">
  <p>This wiki provides everything needed to build a 30 ft geodesic dome:</p>
  <ul style="margin-left:1.5rem;margin-top:0.5rem;">
    <li><strong>Interactive 3D previews</strong> — inspect strut types, hub positions, and dome geometry in real time</li>
    <li><strong>Downloadable CAD files</strong> — STL for 3D printing, OBJ for CAD import, DXF for CNC/laser hub plates</li>
    <li><strong>Exact chord factors</strong> — from the Berkeley Math Circle paper by Tom Davis (2004)</li>
    <li><strong>Material estimates</strong> — Home Depot 2026 pricing with shopping lists</li>
    <li><strong>Construction guidance</strong> — assembly times, crew sizes, tool requirements</li>
  </ul>
</div>
